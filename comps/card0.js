...
const Card1 = ({ data }) => {
  return (
    <div className="bg-white grid-start-1 grid-end-1 flex flex-col rounded-xl   sm:flex-row  z-10 relative mt-20 w-full">
      ...
      <span
        className="absolute inset-0 z-10  top-8 left-4 bg-yeal text-white 
      text-sm text-center rounded-2xl w-24 h-8 p-2 "
      >
        {data.FunStac0 !== "0" ? "FUNDED" : "ACTIVE"}
      </span>

      <div className=" w-full md:p-10 p-6 flex flex-col justify-center align-center ">
