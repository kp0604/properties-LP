  ...
  return (
    ...
    >
      <img
        src="buil.jpg"
        alt="img"
        className="sm:h-96 h-52 sm:w-1/2  rounded-l-xl  "
      ></img>
      <div>
        <span
          className="absolute inset-0 z-10  top-8 left-4 bg-yellow-600 text-white 
      text-sm text-center rounded-2xl w-24 h-8 p-2 "
        >
          {data.FunSta !== "0" ? "FUNDED" : "ACTIVE"}
        </span>
        ...
        <div className=" w-full p-10  flex flex-col ">
          ...
          <div className="flex w-full justify-between md:justify-start ">
            <div className=" bg-gray-300 rounded-xl my-4 w-44">
              <div className="border-green-800  border-4 rounded-xl w-20"></div>
            </div>

            <span className="text-green-800 pl-2 md:pl-6 py-2 text-sm font-bold">
              {data.FunSta}% funded
            </span>
          </div>

          <div className="md:grid md:grid-rows-3 md:grid-cols-2 gap-x-12 gap-y-0">
          ...
          <button className="bg-yellow-600 text-white py-4 px-1 mt-6 md:w-60 rounded-xl flex justify-center items-center">
            View Opportunity{" "}
            <svg
              xmlns="http://www.w3.org/2000/svg"
